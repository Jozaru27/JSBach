...
# Executar comanda
OUTPUT=$("$DIR"/"$PROJECTE"/"$DIR_SCRIPTS"/client_srv_cli dmz $comand)

# Determinar títol segons comanda
case "$comand" in
    iniciar)
        TITLE="Iniciar DMZ"
        ICON="🚀"
...
<body>
  <div class="container">
    ...
    <div class="card">
      <div class="card-title">Resultat del Sistema DMZ</div>
